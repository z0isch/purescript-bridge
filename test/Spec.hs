    ...
    it "tests the generation of a whole (dummy) module" $
      let advanced = bridgeSumType (buildBridge defaultBridge) (mkSumType (Proxy :: Proxy (Bar A B M1 C)))
          ...
          txt = T.unlines [ "-- File auto generated by purescript-bridge! --"
                          ...
                          , ""
                          , "instance showBar :: (Generic a, Generic b, Generic (m b)) => Show (Bar a b m c) where"
                          , "  show = gShow"
                          , "instance eqBar :: (Generic a, Generic b, Generic (m b)) => Eq (Bar a b m c) where"
                          , "  eq = gEq"
                          , "instance ordBar :: (Generic a, Generic b, Generic (m b)) => Ord (Bar a b m c) where"
                          , "  compare = gCompare"
                          , ""
                          , ""
                          , "--------------------------------------------------------------------------------"
      ...
      let recType = bridgeSumType (buildBridge defaultBridge) (mkSumType (Proxy :: Proxy (SingleRecord A B)))
          ...
          txt = T.stripEnd $
                T.unlines [ "newtype SingleRecord a b ="
                          ...
                          , ""
                          , "instance showSingleRecord :: (Generic a, Generic b) => Show (SingleRecord a b) where"
                          , "  show = gShow"
                          , "instance eqSingleRecord :: (Generic a, Generic b) => Eq (SingleRecord a b) where"
                          , "  eq = gEq"
                          , "instance ordSingleRecord :: (Generic a, Generic b) => Ord (SingleRecord a b) where"
                          , "  compare = gCompare"
                          , ""
      ...
      let recType = bridgeSumType (buildBridge defaultBridge) (mkSumType (Proxy :: Proxy SomeNewtype))
          ...
          txt = T.stripEnd $
                T.unlines [ "newtype SomeNewtype ="
                          ...
                          , ""
                          , "instance showSomeNewtype :: Show SomeNewtype where"
                          , "  show = gShow"
                          , "instance eqSomeNewtype :: Eq SomeNewtype where"
                          , "  eq = gEq"
                          , "instance ordSomeNewtype :: Ord SomeNewtype where"
                          , "  compare = gCompare"
                          , ""
      ...
      let recType = bridgeSumType (buildBridge defaultBridge) (mkSumType (Proxy :: Proxy SingleValueConstr))
          ...
          txt = T.stripEnd $
                T.unlines [ "newtype SingleValueConstr ="
                          ...
                          , ""
                          , "instance showSingleValueConstr :: Show SingleValueConstr where"
                          , "  show = gShow"
                          , "instance eqSingleValueConstr :: Eq SingleValueConstr where"
                          , "  eq = gEq"
                          , "instance ordSingleValueConstr :: Ord SingleValueConstr where"
                          , "  compare = gCompare"
                          , ""
      ...
      let recType = bridgeSumType (buildBridge defaultBridge) (mkSumType (Proxy :: Proxy SingleProduct))
          ...
          txt = T.stripEnd $
                T.unlines [ "data SingleProduct ="
                          ...
                          , ""
                          , "instance showSingleProduct :: Show SingleProduct where"
                          , "  show = gShow"
                          , "instance eqSingleProduct :: Eq SingleProduct where"
                          , "  eq = gEq"
                          , "instance ordSingleProduct :: Ord SingleProduct where"
                          , "  compare = gCompare"
                          , ""
                          , ""
                          , "--------------------------------------------------------------------------------"
